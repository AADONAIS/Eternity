...
public class ModifyUserUI extends JFrame{
	...
	public ModifyUserUI(final int index,String name,String password,String sex,String age,String phone,String address) {
		...
		telField.setText(phone);
		
		
		addrArea.setBounds(100, 325, 200, 85);
        addrArea.setText(address);
		
		updateButton.setBounds(70, 480, 80, 30);
		...
		updateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                if(!pwdField.getText().equals(cpwdField.getText())){
                	JOptionPane.showMessageDialog(new JFrame(), "两次密码不一致");
                }
		...
		closeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(result==0) {
					ModifyUserUI.this.setVisible(false);
